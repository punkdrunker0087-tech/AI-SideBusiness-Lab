...
6. `CONSTITUTION.md`「Value Score」に従い、利用者価値・品質・感動・
   信頼・利益の5項目（合計100点）を算出する。Value Scoreが60点未満の
   場合、8軸の総合スコアがGo以上であっても「販売しない」提案として
   その旨を明記する（利益を理由に自動承認しない）
7. `cases/<ID>/score-history.md` にこのフェーズのスコアを追記する
   （Asset Score対象案件はAsset Scoreも併記する）
8. 判定案・Value Score・理由をPM経由でCEOへ提出する
...
━━━━━━━━━━
Value Score <0-100>（利用者価値<0-30>／品質<0-20>／感動<0-20>／信頼<0-20>／利益<0-10>）
60点未満の場合: 「Value Score基準未達のため販売非推奨」を明記
━━━━━━━━━━
理由
<各軸の要点を数行で>
```
