...
## Week 1 KPI（2026-07-04〜、Phase 1の最初のマイルストーン）

- 商品数: 3点（達成: AI Company OS Template Kit / Claude Code Prompt
  Pack / AI Business Template Pack。すべて制作・マーケティング資材は
  完成、実際のBOOTH出品は人間の操作待ち）
...
- 各フェーズの達成状況はWeekly Review（`PM.md`）でCEOに報告する
- Phase 1の「初回販売1件」が発生した時点で、`docs/portfolio-strategy.md`
  のAnalytics部新設条件を満たし、Sprint 7（分析部）を開始する
