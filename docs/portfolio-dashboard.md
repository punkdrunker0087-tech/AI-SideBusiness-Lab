...
| PJ-002 | AI Business Template Factory | マーケティング準備中 | PM | 最優先（総合79点/Go、Asset Score★5） | - | 2026-07-03 | BOOTH¥1,480/note¥1,980で出品準備完了（実際の出品はまだ）。cases/PJ-002/marketing.md参照。分析部未実装のため実売上データはまだなし |
