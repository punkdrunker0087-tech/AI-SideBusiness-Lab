...
| 2026-07-14 | 買い手向けnote6本目「同人の確定申告、最初の一歩」（`cases/PJ-002/marketing-note-006-doujin-tax-first-step.md`）を完成原稿で作成。note-005の続編。「同人 確定申告」の検索意図を実検索で確認し着手（Morning Briefの今日の一手）。SEOエンジンv2の記事QA・GEO原則（冒頭で答えを言い切る）を適用。公開はCEO操作待ち |
