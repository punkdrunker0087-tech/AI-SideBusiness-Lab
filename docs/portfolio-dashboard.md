...
| PJ-002 | AI Business Template Factory | 調査中 | 市場調査部 | 未評価 | - | 2026-07-03 | 原文: 「AI Business Template Factory（旧称: AI Prompt Marketplace Builder）。Prompt/Markdown/Notion/Cursor Rules/MCP/SOP等のテンプレートを複数販路で販売する」。B2B・ニッチ・低競争タイプの案件としてPJ-001と対で選定 |
