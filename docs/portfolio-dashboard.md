...
|---|---|---|---|---|---|---|---|
| PJ-001 | YouTube動画要約サービス | 検証中 | 検証部 | 未評価 | - | 2026-07-03 | 市場調査完了（Conditional Go提案、信頼度72%）。詳細: cases/PJ-001/research.md |

状態の凡例: 新規 / 調査中 / 検証中 / 評価中 / CEO判断待ち / 法務確認中 / 開発中 / 運用中 / 改善中 / 撤退検討 / 撤退済
